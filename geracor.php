...
$nome_cor = ['Azul','Branco','Preto','Prata','Vermelho','Verde','Amarelo','Rosa','Laranja','Bege'];
//$sobrenomes = ['Silva','Job','Siqueira','Pereira','Silveira','Krautler','Bueno','Oliveira','Lima','Fregapani'];
